...
# A Site About An Animal 🐶🦎🦉🐬🐷, Due Friday, Feb 29th at 11PM 
...
1. __If you need help, please work with the tutor or me (office hours or set up a time to meet)__{:.highlight} 
	* helping or receiving help from other students is ok as long as it's limited to:
	* high level discussions of algorithms / concepts / etc.
	* help debugging
	* (if you feel like there may be an issue, ask... and / or comment your code explaining who you discussed the algorithm or concept with to prevent false positives when the graders and I look for cases of cheating)
	* ... but do not copy someone else's work
2. __You must submit your own code (do not copy or distribute solutions)__{:.highlight} 
	...
	* copying includes, but is not limited to:
		* cloning code that isn't yours
		* using solutions on line
		* looking at someone else's work and copying from what's on their screen
