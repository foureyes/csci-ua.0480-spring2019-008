...
You'll be using two files for this part of homework:
...
### Initial ROOT URL to retrieve data

```
https://cs.nyu.edu/courses/spring19/CSCI-UA.0480-008/_site/homework/02/
```
This URL will authenticate username and password. Use your username and password that log you in to the website above.

A good practice is to put your credentials in an individual module and require them instead of writing them in the main file. Also **DO NOT** commit and push your own credentials to the Github.
