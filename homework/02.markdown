...
In this part, you'll work with hourly weather data for 30 US & Canadian Cities + 6 Israeli Cities. You'll use higher order functions to analyze the data.

The data for this part a Kaggle Challenge which you can access via [https://www.kaggle.com/selfishgene/historical-hourly-weather-data](https://www.kaggle.com/selfishgene/historical-hourly-weather-data).
